<html>
    ...
    />
     ...
     <script
      ...
      crossorigin="anonymous"
    ></script>
    <script src="https://api.mapbox.com/mapbox-gl-js/v2.1.1/mapbox-gl.js"></script></head>
       @if ($errors->any())
...
.link { background:none; border:none; color:#fe4141; text-align:center; }
        ...
        <div class="login-box">
  <h2>Ticket</h2>
  <form method="post" action="/movie/quantity">
      @csrf
    <div class="user-box">
    ...
    <div class="user-box">
        <input type="number" name="regular_tickets" required="" min="0">
      <label>Regular</label>
    </div>
       <div class="user-box">
      <input type="Number" name="premium_tickets" required="" min="0">
      <label>Premium</label>
    </div>
