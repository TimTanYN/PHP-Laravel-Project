                        ...
                        <div class="movie_card" id="bright">
                            <div class="info_section">
                                <div class="movie_header">
                                    ...
                                    <h1> <xsl:value-of select="order_id"/></h1>
                                    <span class="minutes"> <xsl:value-of select="customer_id"/> </span>
                                    <span class="minutes"> <xsl:value-of select="created_at"/> </span>
                                    <span class="minutes"> <xsl:value-of select="updated_at"/> </span>
                                    <span class="minutes"> <xsl:value-of select="total"/> </span>
                                    <span class="minutes"> <xsl:value-of select="paymentMethod"/> </span>
                                </div>
